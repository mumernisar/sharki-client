    ...
    <Layout transparentHeader transparentTop footerSolidBg>
      <section className="hero-area-one">
        ...
        <div className="hero-images">
          <div
            className="hero-img image-small fancy-bottom "
            data-aos="fade-left"
            data-aos-delay="600"
          >
          ...
          <div
            className="hero-img image-small fancy-top "
            data-aos="fade-right"
            data-aos-delay="700"
          >
              ...
              <div className="col-auto">
                <div className="common-heading mb-30">
                  <span className="tagline">
                    <i className=" fas fa-plus" /> Popular Categories
              ...
              <div className="project-item">
                ...
                <div className="content">
                  ...
                  <div className="author">
                    ...
                    <Link to="/project-1">James W. Barrows</Link>
                  </div>
                  <h5 className="title">
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-xl-4 col-lg-6 col-md-8 col-sm-10">
              <div className="testimonials-content mb-lg-50">
                ...
                <Link to="/testimonial" className="main-btn mt-35">
                  View All Reviews <i className="far fa-arrow-right" />
                </Link>
                <div
                  className="testimonial-author-boxes "
                  data-aos="fade-up"
                  data-aos-delay="200"
                >
              ...
              <div className="testimonial-boxes square-shape">
                <div className="row  justify-content-center">
                  <div className="col-lg-6 col-md-6 col-sm-10">
                    ...
                    <div
                      className="testimonial-box-one mt-30 "
                      data-aos="fade-up"
                      data-aos-delay="100"
                    >
                      <div className="author-info">
        ...
        <div className="container">
          ...
          >
            <div className="row justify-content-center">
              ...
              <div className="col-xl-4 col-lg-5 col-md-9">
                <div className="content">
                  <h2 className="cta-title">Invest in rising projects</h2>
                  <p>
                    Sed perspiciatis unde omniste natus error sit voluptatem
                    accusantium doloremque laudan totamrem aperiam eaque quae
                    abille
                  ...
                  <Link to="/events" className="main-btn">
                    Start Investing <i className="far fa-arrow-right" />
                  </Link>
                </div>
              </div>
            </div>
